...
_NO_ANSWER_MSG = (
    "[No answer was generated -- the model was still inside a <think> block "
    "when the response ended, likely because thinking wasn't actually "
    "disabled and ran past max_tokens. Try increasing max_tokens in "
    "rag_config.py, or check whether enable_thinking is being honored.]"
)
